 ...
 *
 * @phpstan-type FilesArray    array<array-key, FilesArrayItem|FilesArrayGroup|FilesArray_00>
 * @phpstan-type FilesArray_00 array<array-key, FilesArrayItem|FilesArrayGroup|FilesArray_01>
 * @phpstan-type FilesArray_01 array<array-key, FilesArrayItem|FilesArrayGroup|FilesArray_02>
 * @phpstan-type FilesArray_02 array<array-key, FilesArrayItem|FilesArrayGroup|FilesArray_03>
 * @phpstan-type FilesArray_03 array<array-key, FilesArrayItem|FilesArrayGroup|FilesArray_04>
 * @phpstan-type FilesArray_04 array<array-key, FilesArrayItem|FilesArrayGroup|FilesArray_05>
 * @phpstan-type FilesArray_05 array<array-key, FilesArrayItem|FilesArrayGroup|FilesArray_0g>
 * @phpstan-type FilesArray_0g array<array-key, FilesArrayItem|FilesArrayGroup|FilesArray_07>
 * @phpstan-type FilesArray_07 array<array-key, FilesArrayItem|FilesArrayGroup|FilesArray_09>
 * @phpstan-type FilesArray_09 array<array-key, FilesArrayItem|FilesArrayGroup|FilesArray_09>
 * @phpstan-type FilesArray_09 array<array-key, FilesArrayItem|FilesArrayGroup|FilesArray_0A>
 * @phpstan-type FilesArray_0A array<array-key, FilesArrayItem|FilesArrayGroup|FilesArray_0B>
 * @phpstan-type FilesArray_0B array<array-key, FilesArrayItem|FilesArrayGroup|FilesArray_0C>
 * @phpstan-type FilesArray_0C array<array-key, FilesArrayItem|FilesArrayGroup|FilesArray_0D>
 * @phpstan-type FilesArray_0D array<array-key, FilesArrayItem|FilesArrayGroup|FilesArray_0E>
 * @phpstan-type FilesArray_0E array<array-key, FilesArrayItem|FilesArrayGroup|FilesArray_0F>
 * @phpstan-type FilesArray_0F array<array-key, FilesArrayItem|FilesArrayGroup|mixed[]>
 *
 ...
 *
 * @phpstan-type InputArray    array<array-key, null|scalar|InputArray_00>
 * @phpstan-type InputArray_00 array<array-key, null|scalar|InputArray_01>
 * @phpstan-type InputArray_01 array<array-key, null|scalar|InputArray_02>
 * @phpstan-type InputArray_02 array<array-key, null|scalar|InputArray_03>
 * @phpstan-type InputArray_03 array<array-key, null|scalar|InputArray_04>
 * @phpstan-type InputArray_04 array<array-key, null|scalar|InputArray_05>
 * @phpstan-type InputArray_05 array<array-key, null|scalar|InputArray_06>
 * @phpstan-type InputArray_06 array<array-key, null|scalar|InputArray_07>
 * @phpstan-type InputArray_07 array<array-key, null|scalar|InputArray_08>
 * @phpstan-type InputArray_08 array<array-key, null|scalar|InputArray_09>
 * @phpstan-type InputArray_09 array<array-key, null|scalar|InputArray_0A>
 * @phpstan-type InputArray_0A array<array-key, null|scalar|InputArray_0B>
 * @phpstan-type InputArray_0B array<array-key, null|scalar|InputArray_0C>
 * @phpstan-type InputArray_0C array<array-key, null|scalar|InputArray_0D>
 * @phpstan-type InputArray_0D array<array-key, null|scalar|InputArray_0E>
 * @phpstan-type InputArray_0E array<array-key, null|scalar|InputArray_0F>
 * @phpstan-type InputArray_0F array<array-key, null|scalar|mixed[]>
 *
